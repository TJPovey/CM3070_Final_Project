...
namespace SnagIt.API.Core.Application.Features.Property
{
    public class AssignUserToProperty
    {
        ...
        {
            private Command(PropertyUserAssignmentPostDto data, Guid propertyId, Guid userId, string userName)
            {
                Data = data;
                UserId = userId;
                Username = userName;
            ...
            public static Command Create(PropertyUserAssignmentPostDto data, Guid propertyId, Guid userId, string userName)
                => new Command(data, propertyId, userId, userName);

            public PropertyUserAssignmentPostDto Data { get; }
        ...
        public class Validator : AbstractValidator<Command>
        {
            ...
            private class PropertyUserAssignmentPostDtoValidator : AbstractValidator<PropertyUserAssignmentPostDto>
            {
